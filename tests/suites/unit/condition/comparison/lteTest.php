...
/**
 * Test class for PNConditionComparisonLte.
 *
 * @package     Tests.Unit
 * @subpackage  Comparison
 * @since       1.0
 */
class PNConditionComparisonLteTest extends TestCase
{
	/**
	 * @var    PNConditionComparisonLte  A PNConditionComparisonLte instance.
	 * @since  1.0
	 */
	protected $object;
	...
	protected function setUp()
	{
		...
		$this->object = new PNConditionComparisonLte;
	}
	 ...
	 * @covers        PNConditionComparisonLte::execute
	 * @since         1.0
	 */
